...
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\persons_hbw_gz.csv"),"w")
district_squeeze_csv(mf.persons_hbw,ensemble.gy,"persons_hbw",outfile)
close(outfile)

mf.transit_hbw<-(mf.hwtr + mf.hwprtr)
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\transit_hbw_gz.csv"),"w")
district_squeeze_csv(mf.transit_hbw,ensemble.gy,"transit_hbw",outfile)
close(outfile)

mf.bike_hbw<-(mf.hwbike)
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\bike_hbw_gz.csv"),"w")
district_squeeze_csv(mf.bike_hbw,ensemble.gy,"bike_hbw",outfile)
close(outfile)

mf.active_hbw<-(mf.hwbike + mf.hwwalk)
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\active_hbw_gz.csv"),"w")
...
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\persons_hbnw_gz.csv"),"w")
...
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\transit_hbnw_gz.csv"),"w")
district_squeeze_csv(mf.transit_hbnw,ensemble.gy,"transit_hbnw",outfile)
close(outfile)

mf.bike_hbnw<-(mf.hobike + mf.hrbike + mf.hsbike)
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\bike_hbnw_gz.csv"),"w")
...
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\active_hbnw_gz.csv"),"w")
...
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\persons_nhb_gz.csv"),"w")
district_squeeze_csv(mf.persons_nhb,ensemble.gy,"persons_nhb",outfile)
close(outfile)

mf.transit_nhb<-(mf.nhnwtr + mf.nhwtr)
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\transit_nhb_gz.csv"),"w")
district_squeeze_csv(mf.transit_nhb,ensemble.gy,"transit_nhb",outfile)
close(outfile)

mf.bike_nhb<-(mf.nhnwbike + mf.nhwbike)
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\bike_nhb_gz.csv"),"w")
district_squeeze_csv(mf.bike_nhb,ensemble.gy,"bike_nhb",outfile)
close(outfile)

mf.active_nhb<-(mf.nhnwbike + mf.nhnwwalk + mf.nhwbike + mf.nhwwalk)
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\active_nhb_gz.csv"),"w")
...
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\persons_all_gz.csv"),"w")
...
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\transit_all_gz.csv"),"w")
...
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\bike_all_gz.csv"),"w")
...
outfile<-file(file.path(root,"model\\reports\\auto_files\\dist2dist\\active_all_gz.csv"),"w")
